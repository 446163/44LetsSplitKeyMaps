...
[_SHIFT] = KEYMAP( \
  ...
  TO(_LAYER), KC_RBRC, LSFT(KC_LALT), LSFT(KC_LGUI), LSFT(KC_ESC),  KC_TRNS, LSFT(KC_SPC),  KC_BSPC, KC_ENT,  KC_LEFT, KC_DOWN, KC_RGHT \
),
/*
  ┌────┬────┬────┬────┬────┬────┐    ┌────┬────┬────┬────┬────┬────┐
  │HOME│ !  │ "  │ #  │ $  │ %  │    │ &  │ '  │ (  │ )  │ ~  │ ^  │
...
[_MOD] = KEYMAP( \
  ...
  TO(_LAYER), KC_SLEP, KC_LALT, KC_LGUI, KC_TRNS,  KC_LSFT, KC_NO,			KC_BSPC, KC_ENT,  KC_LEFT, KC_DOWN, KC_RGHT \
),
/*
  ┌────┬────┬────┬────┬────┬────┐    ┌────┬────┬────┬────┬────┬────┐
  │ N  │    │    │    │    │RST │    │    │ BD │ BD │    │    │    │
...
[_LAYER] = KEYMAP( \
  ...
  TO(_LAYER),   KC_NO, KC_NO, KC_NO, TO(_COLEMAK), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, TO(_BTEC) \
)};
